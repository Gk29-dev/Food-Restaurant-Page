...
- In this project, I build Food Restaurant Landing page.

- I learned, how to design and align navbar section.

- I learned, how to add padding in buttons.

- I learned, how to set font-size and color of the text.

- I learned, how to set background-image with linear-gradient.

***

### Checkout the webiste : [Click Here](https://restaurant-food-page.netlify.app/)
